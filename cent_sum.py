...
from Coin_game import coin_wrapper
import torch
...
torch.manual_seed(args.seed)
envfolder = "elevator/"
model_name = "centSumR_ag10h5_sparse_rw_"#"centSumR_ag5h4_"#"lift_iac"
file_name = "save_weight/" +envfolder+ model_name
ifload = False
save_eps = 20
ifsave_model = True
...
torch.manual_seed(args.seed)
envfolder = "fish/"
model_name = "fish_sum_"#"clean_centSumR_indi_"#"lift_iac"
file_name = "save_weight/" +envfolder+ model_name
ifload = False
save_eps = 10
ifsave_model = True
